...
const PopUpSuccess = ({ popupRegisterSuccess, message }) => {
  if (!popupRegisterSuccess) {
      return <></>;
  }
  return (
    <>
        ...
        <div className={styles.modalPopup}>
          <div className="relative w-full h-full flex flex-col items-center bg-white shadow rounded-sm">
            ...
            <div className="h-24 w-full flex flex-col justify-between items-center">
              {/* <p className="text-4xl font-thin text-green-600">Tạo user thành công</p> */}
              <p className="text-4xl font-thin text-green-600">{message}</p>
            </div>
