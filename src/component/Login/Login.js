        ...
        <form onSubmit={handleLogin} className="mt-6">
          ...
          <div className="mt-6">
            <button
              ...
              className={`w-full px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-gray-700 rounded-md hover:bg-gray-600 focus:outline-none focus:bg-gray-600 ${posting || errorDisp ? 'cursor-not-allowed' : 'cursor-pointer'}`}>
              {
                posting ?
