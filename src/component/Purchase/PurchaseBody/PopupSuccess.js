...
export default function PopupSuccess({ popupSuccess = null, setPopupSuccess = f => f }) {
  ...
  return (
    <>
      <div className="z-10 fixed left-0 top-0 h-screen w-screen bg-black opacity-60" onClick={() => setPopupSuccess({'goHome': true})}>
      </div>
      <div className="z-10 fixed top-44 inset-x-1/3">
