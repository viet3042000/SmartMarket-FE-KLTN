        ...
        <div className="fixed w-2/3 xl:w-1/3 h-3/4 bg-white rounded-lg">
          <div className="relative w-full h-full">
            ...
            <div className="absolute bottom-4 w-full h-12 px-6 flex justify-between items-center">
              <button type="button" className="mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 sm:mt-0 sm:w-auto sm:text-sm" onClick={() => setPopupEdit(false)}>Exit</button>
